...
public class PreferencesTarifas extends ListActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int a=0;a<ts.numTarifas();a++){
        	listaIYT.add(new IconoYTexto(getResources().getDrawable(android.R.drawable.ic_menu_more), ts.getTarifas().get(a).getNombre(), " "));
        }
	...
	public boolean onOptionsItemSelected (MenuItem item) {
        ...
        case NUEVA_TARIFA:
        	...
        	extras.putInt("idTarifa", 0); //0 = Tarifa nueva
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		//int idTarifa=ts.getId(l.getItemAtPosition(position).toString());
