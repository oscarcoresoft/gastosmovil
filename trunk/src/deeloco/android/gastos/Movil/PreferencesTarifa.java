...
import deeloco.android.pruebas.interfaces.TextBox.TextBoxListener;
...
public class PreferencesTarifa extends ListActivity{
	...
	private List<IconoYTexto> listaIYT = new ArrayList<IconoYTexto>();
	TextView tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
    	...
    	//Nombre de la tarifa
    	listaIYT.add(new IconoYTexto(getResources().getDrawable(R.drawable.vacio), "Nombre", t.getNombre()));
    	//Gasto Mínimo
    	listaIYT.add(new IconoYTexto(getResources().getDrawable(R.drawable.vacio), "Gasto Mínimo Mensual", ""+t.getMinimo()));
    	//Color
    	listaIYT.add(new IconoYTexto(getResources().getDrawable(R.drawable.vacio), "Color", t.getColor()));
    	//Numeros
    	listaIYT.add(new IconoYTexto(getResources().getDrawable(R.drawable.vacio), "Numeros Asociados a la tarifa", t.getNumeros()));
    	//Una entrada para cada franja que tiene la tarifa
    	for (int a=0;a<t.getNumFranjas();a++)
    	{
    		listaIYT.add(new IconoYTexto(getResources().getDrawable(android.R.drawable.ic_menu_more),"Franja Horaria" ,t.getFranjas().get(a).getNombre()));
    	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		IconoYTexto iyt=(IconoYTexto) l.getItemAtPosition(position);
