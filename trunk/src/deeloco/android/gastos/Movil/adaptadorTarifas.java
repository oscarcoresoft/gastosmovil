...
public class adaptadorTarifas extends BaseAdapter {
	...
	public adaptadorTarifas(Context mContext, List<IconoYTexto> elementos)
	{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		IconoYTexto elemento = elementos.get(position);
		return generarFila(elemento);
		
	}
	
	public View generarFila(IconoYTexto elemento)
	{
